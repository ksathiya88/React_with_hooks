...
class App extends Component {
    ...
    //     axios.get('http://localhost:8081/getEmployees').then((employees) => {
    ...
    render() {
        ...
        const employees_jsx = (<div>
                <label>Hello</label>{username}
                <Search onGetEmployees={(employees)=>{
                    this.setState({employees: employees});
                }}></Search>
        ...
        if (isAuthenticated) {
            ...
            return <div><userContext><Login username={this.state.user}
